...
app.post('/api/ai/chat', async (req, res) => {
  try {
    ...
    const runMock = () => {
      ...
      let reply = "I'm here to keep you on track! Let's break down tasks, plan schedules, or chat about focus hacks.";
      let suggestedTask = null;

      if (lastMsg.includes('add') || lastMsg.includes('task') || lastMsg.includes('create')) {
        reply = "I've detected a task creation request! I am scheduling this task right onto your dashboard so you don't forget it.";
        suggestedTask = {
        ...
        reply = "Procrastination is just fear of starting. Open a Pomodoro Sprint on your main priority and commit to just 5 minutes of focused effort. Momentum will take care of the rest!";
      }
